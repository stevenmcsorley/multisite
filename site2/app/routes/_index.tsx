...
export const meta: MetaFunction = () => {
  return [
    { title: "Site 2 Remix App" },
    { name: "description", content: "Welcome to Remix on Site 2!" },
  ];
};
...
export const loader: LoaderFunction = async () => {
  ...
  const result = await pool.query("SELECT * FROM site2_data");
  ...
  return (
    <div className="flex h-screen items-center justify-center">
      <div className="flex flex-col gap-6">
        <header>
          <h1 className="text-2xl font-bold">Welcome to Site 2 Remix App</h1>
        </header>
        <section>
